            ...
            <div className="hidden xl:flex xl:flex-grow items-center gap-[11px] nav_gap">
              ...
              <div className="flex items-center">
                ...
                <Link
                  ...
                  target="_blank"
                  className="bg-[#1a1f2c] rounded-[8px] py-[16px] px-[24px] text-[16px] leading-[1.2em] font-semibold text-white  ml-4 flex items-center hover:bg-[#4770ff] dark:hover:text-white transition-all duration-300"
                >
                  Let's Talk
