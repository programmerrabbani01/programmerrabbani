...
import programming from "@/public/images/programmer/6454136.png";
            ...
            <div className="p-6">
              <div>
                ...
                <div className="flex gap-7 items-center pl-3">
                  <div>
                    <FaBook className="text-gray-400 dark:text-white  text-4xl" />
                  </div>
                  <div>
                    <p className="text-base dark:text-white text-gray-400">
                      2012 - Present
                    </p>
                    <p className="text-lg sm:text-2xl dark:text-white capitalize mb-2 mt-2">
                ...
                <div className="flex gap-7 items-center pl-3">
                  ...
                  <div>
                    <p className="sm:text-base text-xs dark:text-white text-gray-400">
                      2016 - 2020
                    </p>
                    <p className="text-lg sm:text-2xl dark:text-white capitalize mb-2 mt-2">
          ...
          <Card>
            <div className="p-6">
              <div>
                ...
                <div className="">
                  <div className="w-full md:block mt-28">
                    <Image src={programming} alt="programming" />
                  </div>
                  {/* <div className="flex gap-7 items-center pl-3">
                    <div>
                      <BsPersonWorkspace className="text-gray-400 dark:text-white  text-4xl" />
                    </div>
                    <div>
                      <p className="sm:text-base text-xs dark:text-white text-gray-400">
                        2020 - 2021
